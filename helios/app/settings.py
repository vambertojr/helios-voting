...
#ALLOWED_HOSTS = ['votar.ufape.edu.br', 'localhost', '127.0.0.1']

# Make this unique, and don't share it with anybody.
SECRET_KEY = get_from_env('SECRET_KEY', 'change')
ROOT_URLCONF = 'urls'
...
ADMINS = ('Vamberto Rocha Jr', 'vamberto.rocha@ufape.edu.br'
)
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', _('Sistema de Votação Eletrônica da UFAPE'))
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', _('Bem vindo ao Sistema de Votação Eletrônica da UFAPE'))

HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'sti@ufape.edu.br')
...
EMAIL_HOST_USER = 'noreply.votar@ufape.edu.br'
EMAIL_HOST_PASSWORD = 'change' #past the key or password app here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
AUTH_LDAP_SERVER_URI = "ldap://ufape_openldap:389" # replace by your Ldap URI
AUTH_LDAP_BASE_DN = "dc=ufape,dc=edu,dc=br"
AUTH_LDAP_BIND_DN = "cn=admin,dc=ufape,dc=edu,dc=br"
AUTH_LDAP_BIND_PASSWORD = "change"

AUTH_LDAP_USER_SEARCH = LDAPSearch("dc=ufape,dc=edu,dc=br",
